...
const Education = () => {
  return (
    <div className="content-page" style={{border: '6px inset #5AB1D2'}}>
      ...
      Realicé mis estudios de nivel medio superior en el Colegio de Bachilleres del Estado de Sonora (COBACH), donde cursé la preparatoria del año 2018 al 2021. Actualmente, estudio la carrera de Ingeniería en Sistemas Computacionales en el Instituto Tecnológico de Nogales, donde ingresé en el 2021 y planeo graduarme en diciembre del presente año.
      <br/><br/>
